...
const SuperAdminSignInView: React.FC = () => {
  ...
  return (
    <div className="relative grid w-full h-full rounded-lg lg:grid-cols-1">
      <div className="bg-[#3D0000] p-8 lg:p-12 flex flex-col min-h-[600px]">
        ...
        <div className="flex flex-col items-center justify-center flex-1 text-center">
          ...
          <div className="flex items-center justify-center gap-2 px-6 py-3 mb-8 bg-white rounded-full">
            ...
            <span className="text-xl font-bold text-[#3D0000]">SUPER ADMIN</span>
          </div>
...
export default SuperAdminSignInView
